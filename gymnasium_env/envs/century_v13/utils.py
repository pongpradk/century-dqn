...
def calculate_total_points(player):
    ...
    crystal_points = player.caravan["green"] + player.caravan["blue"]
...
def remove_excess_crystals(player):
    ...
    if total_crystals > GAME_CONSTANTS['MAX_CRYSTALS']:
        ...
        # Remove from yellow first, then green, then blue
        ...
        return (GAME_CONSTANTS['CRYSTAL_VALUES']['yellow'] * excess_yellow) + (GAME_CONSTANTS['CRYSTAL_VALUES']['green'] * excess_green) + (GAME_CONSTANTS['CRYSTAL_VALUES']['blue'] * excess_blue)
