...
class CenturyGolemEnv(gym.Env):
    ...
    def _handle_use_merchant_card(self, action):
        ...
        total_crystals = self.current_player.caravan["yellow"] + self.current_player.caravan["green"]
    ...
    def _handle_get_golem_card(self, action):
        ...
        if (golem_card in self.golem_market and 
            ...
            if self.current_player.golem_count == 1:
                win_proximity_bonus = GAME_CONSTANTS['REWARDS']['WIN_PROXIMITY']
            elif self.current_player.golem_count == 2:
    ...
    def _get_info(self):
        return {
            ...
            "final_yellow_crystals": self.current_player.caravan["yellow"],
            "final_green_crystals": self.current_player.caravan["green"]
        }
