...
class CenturyGolemEnv(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        self.observation_space = spaces.Dict({
            ...
            "player1_merchant_cards": spaces.MultiDiscrete([3] * 45),
            ...
            "player2_merchant_cards": spaces.MultiDiscrete([3] * 45),
    ...
    def reset(self, seed=None, options=None):
        if self.render_mode == "text":
            print("Century: Golem Edition | Version 15\n")
        ...
        for player in (self.player1, self.player2):
            ...
            player.merchant_cards = [2, 2] + [0] * 43
    ...
    def _get_valid_actions(self, player):
        ...
        for i in range(Actions.useM1.value, Actions.useM45.value + 1):
