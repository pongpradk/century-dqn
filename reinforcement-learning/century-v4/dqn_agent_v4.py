...
class DQNAgent:
    ...
    def save_agent(self, filename_prefix):
        ...
        print(f"[INFO] Agent saved with prefix '{filename_prefix}'.")

    def load_agent(self, filename_prefix):
        """Load the agent's models, epsilon, and replay buffer."""
        # Load Main and Target Network weights
...
if __name__ == '__main__':
    ...
    env = gym.make("gymnasium_env/CenturyGolem-v4")
