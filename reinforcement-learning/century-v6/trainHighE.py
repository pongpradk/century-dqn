...
if __name__ == '__main__':
    ...
    try:
        ...
        dqn_agent.save_agent('highE')
        save_training_metadata('training_metadataHighE.json', {
            'episode': ep + 1,
            'time_step': time_step,
            'rewards': rewards,
        ...
        with open('rewardsHighE.txt', 'w') as f:  # Overwrite with full updated list
            f.write(json.dumps(updated_rewards))
        print("Rewards of the training saved in 'rewardsHighE.txt'")
        ...
        with open('epsilon_valuesHighE.txt', 'w') as f:  # Overwrite with full updated list
            f.write(json.dumps(updated_epsilon_values))
        print("Epsilon values of the training saved in 'epsilon_valuesHighE.txt'")
