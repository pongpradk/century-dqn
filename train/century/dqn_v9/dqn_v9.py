...
class DQNConfig:
    def __init__(self, **kwargs):
        ...
        self.checkpoint_freq = kwargs.get('checkpoint_freq', 50)  # More frequent checkpoints
...
if __name__ == '__main__':
    ...
    config_dict = {
        ...
        'checkpoint_freq': args.checkpoint_freq if args.checkpoint_freq is not None else 50,  # More frequent checkpoints
